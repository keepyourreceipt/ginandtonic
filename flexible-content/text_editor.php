<?php
  ...
  get_sub_field('content_width') == "full" ? $width_classes = "col-md-10 col-md-offset-1 col-lg-8 col-lg-offset-2" : $width_classes = "col-md-8 col-md-offset-2 col-lg-6 col-lg-offset-3";
?>

...
<div class="hidden-xs hidden-sm call-to-action">
...
<div class="hidden-md hidden-lg hidden-xl call-to-action-mobile">
  <div class="jumbotron background-image waypoint waypoint-left-to-right" style="background-image: url(<?php echo $featured_image_obj['sizes']['full-hd']; ?>);">
    <?php // Background image container ?>
  </div>
  <div class="row">
    <div class="container">
